...
<div id="featured_slider">
	...
	<ul id="slider">
		...
		<li><div class="count"><?php echo do_shortcode('[post_view]'); ?></div><div class="content_left"><h3><a href="<?php the_permalink();?>"><?php the_title();?></a></h3><p><?php echo c_slider_cut_text(get_the_content(), $c_slider_limit, $c_slider_points);?></p></div><div class="img_right"><a href="<?php the_permalink();?>"><img src="<?php echo $c_slider_thumb;?>" /></a></div></li>
